...
class LanguageListViewController: BaseViewController {
    ...
    var selectedLanguage: Language = Preference.language
    ...
    @objc
    private func done(){
//        Languages.setLanguage(lang: selectedLanguage)
        AppLanguage.set(language: selectedLanguage)
...
extension LanguageListViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        selectedLanguage = languages[indexPath.row].language
    }
}
